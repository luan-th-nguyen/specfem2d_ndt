...
%print(1,'-dpng','../figs/model1_disp_40kHz_pure','-r150')
%print(1,'-dpng','../figs/model1_disp_40kHz_polluted','-r150')
%print(1,'-dpng','../figs/model1_disp_100kHz_pure','-r150')
print(1,'-dpng','../figs/model1_disp_100kHz_polluted','-r150')